            ...
            else
            {
                ...
                foreach (DataGridViewRow row in dgvdata.Rows)
                {
                    if (row.Visible)
                        ...
                        {
                            row.Cells[2].Value.ToString(), //nro documento
                            row.Cells[3].Value.ToString(), //nombre
                            row.Cells[4].Value.ToString(), //correo
                            row.Cells[7].Value.ToString(), //rol
                            row.Cells[9].Value.ToString(), //estado
                        });
                }
